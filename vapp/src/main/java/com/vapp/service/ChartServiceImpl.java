...
public class ChartServiceImpl implements ChartService {
	...
	public Map<String, Object> getSingleData(String fromDate, String toDate,
			String type) {
	...
	public Map<String, Object> getAllData(String fromDate, String toDate,
			String type) {
		Map<String, Object> result = new LinkedHashMap<String, Object>();
		...
		else if ("Operating Expense vs Revenue vs Profit/Loss".equalsIgnoreCase(type))
			data = chartDao.getOperRevenuePL(fromDate, toDate);
		if (data != null && data.size() > 0) {
